const casasJson = [
  ...
  { id: 0, nome: "Início", x: 47, y: 83, funcao: "saida", value: 200, listaJogadores: [] },
  ...
  { id: 4, nome: "Boa Viagem", x: 30, y: 64, funcao: "praia", listaJogadores: [],  price: 200, fee: 60, lateral: 1, casaConstruida: 0, proprietarioCor: "" },
...
{ id: 8, nome: "MAC", x: 10, y: 45, funcao: "companhia", proprietarioCor: "", listaJogadores: [] },
  ...
  { id: 14, nome: "Itaipu", x: 35, y: 15, funcao: "praia", price: 200, fee: 60, proprietarioCor: "", listaJogadores: [], lateral: 2 , casaConstruida: 0},
...
// Lado esquerdo (descendo)
  ...
  { id: 18, nome: "Camboinhas", x: 60, y: 15, funcao: "praia", price: 200, fee: 60, casaConstruida: 0, proprietarioCor: "", listaJogadores: [], lateral: 3 },
  ...
  { id: 20, nome: "Sorte", x: 68, y: 25, funcao: "sorte", listaJogadores: [], lateral: 3 },
  { id: 21, nome: "Barreto", x: 74, y: 30, cor: "red", funcao: "propriedade", prices: [440, 600, 780, 1020], fee: [80, 90, 100, 120], casaConstruida: 0, proprietarioCor: "", listaJogadores: [], lateral: 3 },
...
{ id: 24, nome: "Terminal", x: 85, y: 45, funcao: "companhia", proprietarioCor: "", listaJogadores: [] },

  { id: 25, nome: "Itacoatiara", x: 80, y: 50, funcao: "praia", price: 200, fee: 60, casaConstruida: 0, proprietarioCor: "", listaJogadores: [], lateral: 4 },
  { id: 26, nome: "São Lourenço", x: 76, y: 53, cor: "yellow", funcao: "propriedade", prices: [520, 680, 860, 1100], fee: [100, 110, 120, 140], casaConstruida: 0, proprietarioCor: "", listaJogadores: [], lateral: 4 },
  { id: 27, nome: "Viradouro", x: 71, y: 58, cor: "yellow", funcao: "propriedade", prices: [540, 700, 880, 1120], fee: [105, 115, 125, 145], casaConstruida: 0, proprietarioCor: "", listaJogadores: [], lateral: 4 },
  ...
  { id: 30, nome: "Imposto", x: 59, y: 72, funcao: "imposto", listaJogadores: [], lateral: 4 },
