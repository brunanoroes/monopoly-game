...
{ id: 8, nome: "MAC", x: 10, y: 45, tipo: "companhia", proprietarioCor: "", listaJogadores: [] },
  ...
  { id: 10, nome: "Jardim Icaraí", x: 18, y: 33, cor: "white", tipo: "propriedade", prices: [320, 480, 660, 900], fee: [50, 60, 70, 90], rodadasJogador: { jogadorCor: "", rodadas: 0 }, listaJogadores: [], lateral: 2 },
  { id: 11, nome: "Engenho do Mato", x: 22, y: 28, cor: "white", tipo: "propriedade", prices: [320, 480, 660, 900], fee: [50, 60, 70, 90], casaConstruida: 0, proprietarioCor: "", listaJogadores: [], lateral: 2 },
